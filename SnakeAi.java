...
public class SnakeAi {
	 ...
	 * @return
	 */
	public int method(Snake s,Node f){
	...
	public int method1(Snake s,Node f) {
	...
	public int method2(Snake snake,Node f){
